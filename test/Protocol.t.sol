...
contract ProtocolTest is Test, IProtocolTest{
   ...
   address DAI_USD = 0xAed0c38402a5d19df6E4c03F4E2DceD6e29c1ee9;
    ...
    function test_borrowerCan_AcceptOfferRequest() public {
        testUser_CanGiveOffer_ToRequest();
        switchSigner(owner);
        // protocol.respondToLendingOffer(1, 0, Protocol.OfferSt);c
        protocol.respondToLendingOffer(1, 0, Protocol.OfferStatus.ACCEPTED);
